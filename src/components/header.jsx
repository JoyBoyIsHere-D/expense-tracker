...
function Header(props) {
    ...
    return (<div className="header">
        ...
        <a class="logo" onClick={() => props.scrolling(props.section1)}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" color="#fff" fill="none">
        ...
        <nav>
            <a onClick={() => props.scrolling(props.section1)} >Dashboard</a>
            <a onClick={() => props.scrolling(props.section2)}>Transactions</a>
            <a onClick={() => props.scrolling(props.section3)} >Reports</a>
